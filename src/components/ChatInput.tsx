  ...
  const models = [
    {
      id: "groq",
      name: "Llama 3.3 70B",
      description: "Versatitle Large Language Model",
    },
    {
      id: "gemini",
      ...
      <button
        ...
        className={`flex items-center gap-2 px-3 py-1.5 text-sm transition-colors ${
          isDisabled
            ...
            : "text-muted-foreground fover:text-foreground"
        }`}
        disabled={isDisabled}
  ...
  return (
    <div className="relative border-t-2 border-border">
      ...
      <div className="flex items-center pl-[48px] md:pl-[220px] pr-10 md:pr-12">
        ...
        />
        <button onClick={handleSend} disabled={!message.trim() || disabled || isLoading} className="absolute right-2 md:right-4 text-primary hover:text-muted-foreground disabled:text-muted-foreground disabled:hover:text-muted-foreground transition-colors">
